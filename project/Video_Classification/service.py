...
def func1(src):
     ...
     #print("SOUT:: "+s_out)
     os.system("python classify_nsfw_video.py -m data/open_nsfw-weights.npy kidtube\project\Video_Classification\videos"+src +" >> result.txt")
     infile = open('C:/Users/Fiza Shaikh/Documents/VideoCategorization/app/result.txt', 'r')
     ...
     infile.close()    
     os.remove("C:/Users/Fiza Shaikh/Documents/VideoCategorization/app/result.txt")
